...
#define I8    char
#define U8  unsigned char     /* unsigned 8  bits. */
#define I16  short    /*   signed 16 bits. */
#define U16 unsigned short    /* unsigned 16 bits. */
#define I32   int /*   signed 32 bits. */
#define U32  unsigned int/* unsigned 32 bits. */
#define I16P I16              /*   signed 16 bits OR MORE ! */
#define U16P U16              /* unsigned 16 bits OR MORE ! */
...
#define LCD_DRAWMODE_SHADOW    (1<<3)

#define LCD_FONTMODE_8BPP32              (0)
#define LCD_FONTMODE_8BPP256            (1<<0)
#define LCD_FONTMODE_8BPP128_1         (1<<1)    // font color 1
#define LCD_FONTMODE_8BPP128_2         (1<<2)    // font color 2
#define LCD_FONTMODE_32BPPSHADOW   (1<<3)   // 32bpp font shadow
#define LCD_FONTMODE_8BPP32_FRAME   (1<<4)  // 8bpp32 font frame mode
#define LCD_FONTMODE_MONO           (1<<5)  //font mode mono
#define LCD_FONTMODE_32BPPMAG2        (1<<6)
#define LCD_FONTMODE_8BPP32_FRAME_MAG  (1<<7)
/*      *************************************************************
        *                                                           *
        *                Typedefs                                   *
        *                                                           *
...
extern const struct tLCDDEV_APIList_struct GUI_MEMDEV__APIList32;   //mcl add 2008.12.23
...
#define GUI_MEMDEV_APILIST_32 &GUI_MEMDEV__APIList32    //mcl add 2008.12.23
#endif
...
LCD_FONTMODE  LCD_SetFontMode(LCD_FONTMODE fm)  ;     // mcl  add
