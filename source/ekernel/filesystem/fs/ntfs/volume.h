...
struct _ntfs_volume
{
    ...
    struct super_block *v_sb;   /* For kernel porting compatibility. */
};
...
extern ntfs_volume *ntfs_volume_startup(__hdle part, u32 flags);
...
extern __s32 ntfs_fill_super(struct super_block *sb, void *data, __s32 silent);

extern int ntfs_part_identify(__hdle p_part);
