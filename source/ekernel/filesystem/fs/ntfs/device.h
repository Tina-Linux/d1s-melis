...
extern s64 ntfs_pread(__hdle part, const s64 pos, s64 count,
                      void *b);
extern s64 ntfs_pwrite(__hdle part, const s64 pos, s64 count,
                       const void *b);

extern s64 ntfs_mst_pread(__hdle part, const s64 pos, s64 count,
                          const u32 bksize, void *b);
extern s64 ntfs_mst_pwrite(__hdle part, const s64 pos, s64 count,
                           const u32 bksize, void *b);
...
extern s32 ntfs_set_dev_sctsize(s32 size);
extern s64 ntfs_device_size_get(__hdle part, int block_size);
extern s64 ntfs_device_partition_start_sector_get(__hdle part);
extern int ntfs_device_heads_get(__hdle part);
extern int ntfs_device_sectors_per_track_get(__hdle part);
extern int ntfs_device_sector_size_get(__hdle part);
extern int ntfs_device_block_size_set(__hdle part, int block_size);
