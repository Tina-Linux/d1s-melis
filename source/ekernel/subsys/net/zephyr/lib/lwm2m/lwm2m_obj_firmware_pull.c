...
static void firmware_udp_receive(struct net_context *ctx, struct net_pkt *pkt, int status,
                                 void *user_data)
{
...
static int do_firmware_transfer_reply_cb(const struct zoap_packet *response,
