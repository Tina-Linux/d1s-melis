...
struct media_device {
	...
	struct list_head entities;  //media_entity
 ...
 */
static inline  int media_entity_enum_init(
...
static inline struct media_device *media_device_get_devres(struct rt_device *dev)
{
	return NULL;
}
static inline struct media_device *media_device_find_devres(struct rt_device *dev)
{
	return NULL;
}
