...
static ERRORTYPE loadSampleAecConfig(SampleAecConfig *pConfig, const char *conf_path)
{
    ...
    if(conf_path != NULL)
    {
        ...
        pConfig->aec_delay_ms = GetConfParaInt(&stConfParser, SAMPLE_AEC_AEC_DELAY_MS, 0);
        pConfig->ai_aec_en = GetConfParaInt(&stConfParser, SAMPLE_AEC_AEC_ENABLE, 0);
