# Makefile for eyesee-mpp/middleware/sample/sample_virvi2venc2ce
CUR_PATH := .
PACKAGE_TOP := ../..
...
INCLUDE_DIRS := \
    ...
    $(EYESEE_MPP_INCLUDE)/system/public/libcrypto \
...
LOCAL_TARGET_STATIC :=
LOCAL_TARGET_BIN := sample_virvi2venc2ce

#generate include directory flags for gcc.
inc_paths := $(foreach inc,$(filter-out -I%,$(INCLUDE_DIRS)),$(addprefix -I, $(inc))) \
                $(filter -I%, $(INCLUDE_DIRS))
#Extra flags to give to the C compiler
LOCAL_CFLAGS := $(CFLAGS) $(CEDARX_EXT_CFLAGS) $(inc_paths) -fPIC -Wall -Wno-unused-but-set-variable -DOPENSSL_API_COMPAT=0x00908000L
#Extra flags to give to the C++ compiler
