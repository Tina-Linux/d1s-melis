...
class SampleAudioEncode_EyeseeRecorderListener : public EyeseeLinux::EyeseeRecorder::OnErrorListener
...
public:
    ...
    SampleAudioEncode_EyeseeRecorderListener(SampleAudioEncodeContext *pOwner);
private:
...
public:
    ...
    SampleAudioEncode_EyeseeRecorderListener mRecorderListener;
