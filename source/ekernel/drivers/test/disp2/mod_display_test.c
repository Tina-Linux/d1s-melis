...
void jpg_show_test(int argc, char **argv)
{
    ...
    layer.scn_win.x        = 0;
    layer.scn_win.y        = 0;
    layer.scn_win.width    = esMODS_MIoctrl(mp_display, MOD_DISP_GET_SCN_WIDTH, 0, 0);
    layer.scn_win.height   = esMODS_MIoctrl(mp_display, MOD_DISP_GET_SCN_HEIGHT, 0, 0);
    ...
    arg[2] = 0;
    esMODS_MIoctrl(mp_display, MOD_DISP_CMD_LAYER_SET_SRC_WINDOW, 0, (void *)arg);
}
