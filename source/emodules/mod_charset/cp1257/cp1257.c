...
static int cp1257_mbtowc(__u16 *pwc, const unsigned char *s, int n)
{
    unsigned char c;
...
static int cp1257_wctomb(unsigned char *r, __u16 wc, int n)
{
    unsigned char c = 0;
...
__s32 CP1257_uni2char(const __u16 uni, __u8 *out, __u32 boundlen)
{
    __s32 n;
    n = cp1257_wctomb(out, uni, boundlen);
...
__s32 CP1257_char2uni(const __u8 *rawstring, __u32 boundlen, __u16 *uni)
{
    __s32 n;
    n = cp1257_mbtowc(uni, rawstring, boundlen);
...
__u32 CP1257_get_charset2upper_table(void *buf, __u32 size)
{
    __u32  len;
...
__u32 CP1257_get_charset2lower_table(void *buf, __u32 size)
{
    __u32  len;
