...
__s32 ISO8859_3_uni2char(__u16 uni, __u8 *out, __u32 boundlen)
{
...
__s32 ISO8859_3_char2uni(const __u8 *rawstring, __u32 boundlen, __u16 *uni)
{
    if (boundlen <= 0)
    {
        return -EINVAL;
...
__u32 ISO8859_3_get_charset2upper_table(void *buf, __u32 size)
{
    __u32  len;
...
__u32 ISO8859_3_get_charset2lower_table(void *buf, __u32 size)
{
    __u32  len;
