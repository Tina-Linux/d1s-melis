...
GUI_CONST_STORAGE GUI_FONT GUI_Font6x8 = { GUI_FONTTYPE_MONO, 8, 8, 1, 1, {&GUI_F6x8_Mono}, 7, 5, 7 ,{0,0,0}};
GUI_CONST_STORAGE GUI_FONT GUI_Font6x9 = { GUI_FONTTYPE_MONO, 8, 9, 1, 1, {&GUI_F6x8_Mono}, 7, 5, 7 ,{0,0,0}};

GUI_FONT *GUI_GetDefaultFont(void)
{
    return (GUI_FONT *)&GUI_Font6x8;
}