...
static FT_Error ft_lzw_check_header(FT_Stream  stream)
{
    FT_Error  error;
    FT_Byte   head[2];
...
static void ft_lzw_file_done(FT_LZWFile  zip)
{
    /* clear the rest */
...
static FT_Error ft_lzw_file_reset(FT_LZWFile  zip)
{
...
static FT_Error ft_lzw_file_fill_output(FT_LZWFile  zip)
{
    FT_LzwState  lzw = &zip->lzw;
    FT_ULong     count;
    FT_Error     error   = 0;
...
static FT_Error ft_lzw_file_skip_output(FT_LZWFile  zip,
                                        FT_ULong    count)
{
    FT_Error  error = LZW_Err_Ok;
...
static FT_ULong ft_lzw_file_io(FT_LZWFile  zip,
                               FT_ULong    pos,
                               FT_Byte    *buffer,
                               FT_ULong    count)
{
...
static FT_ULong ft_lzw_stream_io(FT_Stream  stream,
                                 FT_ULong   pos,
                                 FT_Byte   *buffer,
                                 FT_ULong   count)
{
