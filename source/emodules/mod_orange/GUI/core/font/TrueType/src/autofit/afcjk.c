...
static FT_Error af_cjk_metrics_init(AF_LatinMetrics  metrics,
                                    FT_Face          face)
{
...
static void af_cjk_metrics_scale_dim(AF_LatinMetrics  metrics,
                                     AF_Scaler        scaler,
                                     AF_Dimension     dim)
{
    AF_LatinAxis  axis;
...
static void af_cjk_metrics_scale(AF_LatinMetrics  metrics,
                                 AF_Scaler        scaler)
{
...
static FT_Error af_cjk_hints_compute_segments(AF_GlyphHints  hints,
        AF_Dimension   dim)
{
...
static void af_cjk_hints_link_segments(AF_GlyphHints  hints,
                                       AF_Dimension   dim)
{
    AF_AxisHints  axis          = &hints->axis[dim];
    AF_Segment    segments      = axis->segments;
...
static FT_Error af_cjk_hints_compute_edges(AF_GlyphHints  hints,
        AF_Dimension   dim)
{
    AF_AxisHints  axis   = &hints->axis[dim];
...
static FT_Error af_cjk_hints_detect_features(AF_GlyphHints  hints,
        AF_Dimension   dim)
{
    FT_Error  error;
...
static FT_Error af_cjk_hints_init(AF_GlyphHints    hints,
...
static FT_Pos af_cjk_snap_width(AF_Width  widths,
                                FT_Int    count,
                                FT_Pos    width)
{
    int     n;
...
static FT_Pos af_cjk_compute_stem_width(AF_GlyphHints  hints,
                                        AF_Dimension   dim,
                                        FT_Pos         width,
...
static void af_cjk_align_linked_edge(AF_GlyphHints  hints,
                                     AF_Dimension   dim,
                                     AF_Edge        base_edge,
                                     AF_Edge        stem_edge)
{
...
static void af_cjk_align_serif_edge(AF_GlyphHints  hints,
                                    AF_Edge        base,
                                    AF_Edge        serif)
{
    FT_UNUSED(hints);
...
static FT_Pos af_hint_normal_stem(AF_GlyphHints  hints,
                                  AF_Edge        edge,
                                  AF_Edge        edge2,
                                  FT_Pos         anchor,
                                  AF_Dimension   dim)
...
static void af_cjk_hint_edges(AF_GlyphHints  hints,
                              AF_Dimension   dim)
{
    AF_AxisHints  axis       = &hints->axis[dim];
    AF_Edge       edges      = axis->edges;
...
static void af_cjk_align_edge_points(AF_GlyphHints  hints,
                                     AF_Dimension   dim)
{
    AF_AxisHints  axis       = & hints->axis[dim];
    AF_Edge       edges      = axis->edges;
...
static FT_Error af_cjk_hints_apply(AF_GlyphHints    hints,
                                   FT_Outline      *outline,
                                   AF_LatinMetrics  metrics)
{
    FT_Error  error;
