...
/*               direction!                                              */
/*                                                                       */
static void blit_sbit(FT_Bitmap  *target,
                      FT_Byte    *source,
                      FT_Int      line_bits,
                      FT_Bool     byte_padded,
                      FT_Int      x_offset,
...
/*                                                                       */
static FT_Error Load_SBit_Const_Metrics(TT_SBit_Range  range,
                                        FT_Stream      stream)
{
    FT_Error  error;
...
/*    FreeType error code.  0 means success.                             */
/*                                                                       */
static FT_Error Load_SBit_Range_Codes(TT_SBit_Range  range,
                                      FT_Stream      stream,
...
/*    FreeType error code.  0 means success.                             */
/*                                                                       */
static FT_Error Load_SBit_Range(TT_SBit_Range  range,
                                FT_Stream      stream)
{
    FT_Error   error;
    FT_Memory  memory = stream->memory;
...
/*                                                                       */
static FT_Error find_sbit_range(FT_UInt          glyph_index,
                                TT_SBit_Strike   strike,
...
/*                                                                       */
static void crop_bitmap(FT_Bitmap       *map,
                        TT_SBit_Metrics  metrics)
{
    /***********************************************************************/
    /*                                                                     */
...
static FT_Error Load_SBit_Single(FT_Bitmap       *map,
                                 FT_Int           x_offset,
                                 FT_Int           y_offset,
                                 FT_Int           pix_bits,
...
static FT_Error Load_SBit_Image(TT_SBit_Strike   strike,
                                TT_SBit_Range    range,
                                FT_ULong         ebdt_pos,
