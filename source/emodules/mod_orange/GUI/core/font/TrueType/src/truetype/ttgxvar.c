...
/*                                                                       */
static FT_UShort *ft_var_readpackedpoints(FT_Stream  stream,
        FT_UInt   *point_cnt)
{
    FT_UShort *points;
    FT_Int     n;
...
/*                                                                       */
static FT_Short *ft_var_readpackeddeltas(FT_Stream  stream,
        FT_Int     delta_cnt)
{
    FT_Short  *deltas;
    FT_Int     runcnt;
...
/*    face :: The font face.                                             */
/*                                                                       */
static void ft_var_load_avar(TT_Face  face)
{
...
/*                                                                       */
static FT_Error ft_var_load_gvar(TT_Face  face)
{
    FT_Stream     stream = FT_FACE_STREAM(face);
    FT_Memory     memory = stream->memory;
    GX_Blend      blend  = face->blend;
...
/*                                                                       */
static FT_Fixed ft_var_apply_tuple(GX_Blend   blend,
