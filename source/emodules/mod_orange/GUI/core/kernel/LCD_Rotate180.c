                           ...
                           const U8 GUI_UNI_PTR *pPixel, const LCD_PIXELINDEX *pTrans)
{
    ...
    if ((xMul == 1) && (yMul == 1))
    {
        ...
        {
            int Diff = y0 - GUI_Context.ClipRect[GUI_Context.SelLayer].y1;
            y0       = GUI_Context.ClipRect[GUI_Context.SelLayer].y1;
        ...
        {
            Diff   = x0 - GUI_Context.ClipRect[GUI_Context.SelLayer].x1;
            xsize -= Diff;
