...
static U16 _GetCharCode(const char GUI_UNI_PTR *s)
{
    ...
    if (esCHS_Char2Uni(EPDK_CHARSET_ENM_CP1250, (__u8 *)s, 8, &r) <= 0)
    {
        r = 1;
    }
...
{
    int r;
    r = esCHS_Uni2Char(EPDK_CHARSET_ENM_CP1250, Char, (__u8 *)s, 3);
...
void GUI_UC_SetEncodeCP1250(void)
{
    ...
    GUI_Context.charset_enum = EPDK_CHARSET_ENM_CP1250;
    GUI_UNLOCK();
}
