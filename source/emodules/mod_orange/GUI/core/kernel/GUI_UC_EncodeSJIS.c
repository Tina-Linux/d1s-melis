...
*
* Moudle  : lemon
* File    : GUI_UC_EncodeKorea.C
* Purpose : Encoding routines
*
* By      : Miracle
* Version : v1.0
* Date    : 2009-9-2 11:12:11
**********************************************************************************************************************
*/
...
static U16 _GetCharCode(const char GUI_UNI_PTR *s)
{
    ...
    if (esCHS_Char2Uni(EPDK_CHARSET_ENM_SJIS, (__u8 *)s, 8, &r) <= 0)
    {
        r = 1 ;
    }
...
{
    int r;
    r = esCHS_Uni2Char(EPDK_CHARSET_ENM_SJIS, Char, (__u8 *)s, 3);
...
void GUI_UC_SetEncodeSJIS(void)
{
    ...
    GUI_Context.charset_enum = EPDK_CHARSET_ENM_SJIS;
    GUI_UNLOCK();
}
