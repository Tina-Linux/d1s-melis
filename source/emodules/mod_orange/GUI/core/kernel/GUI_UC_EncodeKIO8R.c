...
static U16 _GetCharCode(const char GUI_UNI_PTR *s)
{
    ...
    if (esCHS_Char2Uni(EPDK_CHARSET_ENM_KIO8_R, (__u8 *)s, 8, &r) <= 0)
    {
        r = 1;
    }
...
{
    int r;
    r = esCHS_Uni2Char(EPDK_CHARSET_ENM_KIO8_R, Char, (__u8 *)s, 3);
...
void GUI_UC_SetEncodeKIO8R(void)
{
    ...
    GUI_Context.charset_enum = EPDK_CHARSET_ENM_KIO8_R;
    GUI_UNLOCK();
}
