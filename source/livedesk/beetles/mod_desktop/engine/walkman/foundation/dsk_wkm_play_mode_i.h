...
*                                                  All Rights Reserved
*
* File Name   : dsk_wkm_play_mode_i.h
*
* Author      : Gary.Wang
*
* Version     : 1.0
...
************************************************************************************************************************
*/
#ifndef  __DSK_WKM_PLAY_MODE_I_H__
#define  __DSK_WKM_PLAY_MODE_I_H__
...
*Other       :
***************************************************************************************************/
extern __s32  __dsk_wkm_set_play_mode(orc_play_mode_e  play_mode);
...
*Other       :
***************************************************************************************************/
extern orc_play_mode_e  __dsk_wkm_get_play_mode(void);
...
#endif     //  ifndef __DSK_WKM_PLAY_MODE_I_H__

/* end of dsk_wkm_play_mode_i.h */
