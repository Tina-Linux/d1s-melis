...
************************************************************************************************************************
*/
#ifndef  __DSK_WKM_SPECTRUM_C__
#define  __DSK_WKM_SPECTRUM_C__
...
****************************************************************************************************
*/
__s32  dsk_wkm_enable_spectrum(void)
{
    __u8   err;
    __s32  ret;
...
****************************************************************************************************
*/
__s32  dsk_wkm_disable_spectrum(void)
{
    __u8   err;
    __s32  ret;
    ...
    g_pend_mutex(dsk_wkm_res_mutex, &err);
    ret = __dsk_wkm_disable_spectrum();
    g_post_mutex(dsk_wkm_res_mutex);
    return ret;
}
...
****************************************************************************************************
*/
__s32 dsk_wkm_get_spectrum_info(__u16 *value_list)
{
    __u8   err;
    __s32  ret;
    ...
    g_pend_mutex(dsk_wkm_res_mutex, &err);
    ret = __dsk_wkm_get_spectrum_info(value_list);
    g_post_mutex(dsk_wkm_res_mutex);
    return ret;
}
...
#endif     //  ifndef __DSK_WKM_SPECTRUM_C__

/* end of dsk_wkm_spectrum.c */
