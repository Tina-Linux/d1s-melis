 ...
 ******************************************************************************
  ...
  Created       : 2016/06/07
  Last Modified : 2021-06-02 11:07:05
            ...
            if(RcAttr.mVEncType == mVEncRcAttr.mVEncType && RcAttr.mRcMode == mVEncRcAttr.mRcMode)
            {
                ...
                if(VideoRCMode_CBR == RcAttr.mRcMode)
                {
                    if(PT_H264 == RcAttr.mVEncType)
                    {
                        ...
                        {
                            alogd("need update h264 cbr bitRate[%d]->[%d]", mVEncRcAttr.mAttrH264Cbr.mBitRate, RcAttr.mAttrH264Cbr.mBitRate);
                        ...
                        //qp control
                        if(mVEncRcAttr.mAttrH264Cbr.mMaxQp != RcAttr.mAttrH264Cbr.mMaxQp
                            || mVEncRcAttr.mAttrH264Cbr.mMinQp != RcAttr.mAttrH264Cbr.mMinQp
                            || mVEncRcAttr.mAttrH264Cbr.mMaxPqp != RcAttr.mAttrH264Cbr.mMaxPqp
                            || mVEncRcAttr.mAttrH264Cbr.mMinPqp != RcAttr.mAttrH264Cbr.mMinPqp
                            || mVEncRcAttr.mAttrH264Cbr.mQpInit != RcAttr.mAttrH264Cbr.mQpInit
                            || mVEncRcAttr.mAttrH264Cbr.mbEnMbQpLimit != RcAttr.mAttrH264Cbr.mbEnMbQpLimit)
                        {
                            alogd("need update h264 qpInfo[%d,%d,%d,%d,%d,%d]->[%d,%d,%d,%d,%d,%d]",
                                mVEncRcAttr.mAttrH264Cbr.mMaxQp, mVEncRcAttr.mAttrH264Cbr.mMinQp, mVEncRcAttr.mAttrH264Cbr.mMaxPqp, mVEncRcAttr.mAttrH264Cbr.mMinPqp, mVEncRcAttr.mAttrH264Cbr.mQpInit, mVEncRcAttr.mAttrH264Cbr.mbEnMbQpLimit,
                                RcAttr.mAttrH264Cbr.mMaxQp, RcAttr.mAttrH264Cbr.mMinQp, RcAttr.mAttrH264Cbr.mMaxPqp, RcAttr.mAttrH264Cbr.mMinPqp, RcAttr.mAttrH264Cbr.mQpInit, RcAttr.mAttrH264Cbr.mbEnMbQpLimit);
                            
                            VENC_RC_PARAM_S stRcParam;
                            AW_MPI_VENC_GetRcParam(mVeChn, &stRcParam);
                            stRcParam.ParamH264Cbr.mMaxQp = RcAttr.mAttrH264Cbr.mMaxQp;
                            stRcParam.ParamH264Cbr.mMinQp = RcAttr.mAttrH264Cbr.mMinQp;
                            stRcParam.ParamH264Cbr.mMaxPqp = RcAttr.mAttrH264Cbr.mMaxPqp;
                            stRcParam.ParamH264Cbr.mMinPqp = RcAttr.mAttrH264Cbr.mMinPqp;
                            stRcParam.ParamH264Cbr.mQpInit = RcAttr.mAttrH264Cbr.mQpInit;
                            stRcParam.ParamH264Cbr.mbEnMbQpLimit = RcAttr.mAttrH264Cbr.mbEnMbQpLimit;
                            eRet = AW_MPI_VENC_SetRcParam(mVeChn, &stRcParam);
                            if(SUCCESS == eRet)
                            {
                            ...
                            {
                                aloge("fatal error! encType[%d] set rc param fail!", RcAttr.mVEncType);
                            }
                        }
                    }
                ...
                {
                    alogw("Be careful! ignore other rcMode[%d] of encType[%d]", RcAttr.mRcMode, RcAttr.mVEncType);
                }
            }
            else
            {
...
int EyeseeRecorder::addOutputFormatAndOutputSink(MEDIA_FILE_FORMAT_E output_format, int fd, int FallocateLen, bool callback_out_flag)
{
    ...
    muxChnAttr.mCallbackOutFlag = (BOOL)sinkInfo.mCallbackOutFlag;
...
int EyeseeRecorder::addOutputSink(SinkParam *pSinkParam)
{
    ...
    muxChnAttr.mFsWriteMode = FSWRITEMODE_SIMPLECACHE;
    muxChnAttr.mSimpleCacheSize = DEFAULT_SIMPLE_CACHE_SIZE_VFS;
    muxChnAttr.bBufFromCacheFlag = (BOOL)pSinkParam->bBufFromCacheFlag;
    if(mCurrentState==MEDIA_RECORDER_PREPARED || mCurrentState==MEDIA_RECORDER_RECORDING)
    {
        ERRORTYPE ret;
        BOOL nSuccessFlag = FALSE;
...
status_t EyeseeRecorder::prepare()
{
    ...
    if (mVideoEncoder != PT_MAX) 
    {
        ...
        AW_MPI_VENC_SetRcParam(mVeChn, &mVEncRcParam);
        ...
        AW_MPI_VENC_SetHorizonFlip(mVeChn, (BOOL)mbHorizonfilp);
        AW_MPI_VENC_SetAdaptiveIntraInP(mVeChn, (BOOL)mbAdaptiveintrainp);
        ...
        tColor2Grey.bColor2Grey = (BOOL)mbColor2Grey;
...
status_t EyeseeRecorder::config_VENC_CHN_ATTR_S()
{
    ...
    if(PT_H264 == mVEncChnAttr.VeAttr.Type)
    {
       ...
       // mVEncChnAttr.VeAttr.AttrH264e.mbLongTermRef = mbLongTermRef;
        mVEncChnAttr.VeAttr.AttrH264e.FastEncFlag = (BOOL)mFastEncFlag;
       // mVEncChnAttr.VeAttr.AttrH264e.mVirtualIFrameInterval = mVirtualIFrameInterval;
        mVEncChnAttr.VeAttr.AttrH264e.mbPIntraEnable = (BOOL)mbPIntraEnable;
    ...
    else if(PT_H265 == mVEncChnAttr.VeAttr.Type)
    {
        ...
        mVEncChnAttr.VeAttr.AttrH265e.mFastEncFlag = (BOOL)mFastEncFlag;
        //mVEncChnAttr.VeAttr.AttrH265e.mVirtualIFrameInterval = mVirtualIFrameInterval;
        mVEncChnAttr.VeAttr.AttrH265e.mbPIntraEnable = (BOOL)mbPIntraEnable;
    }
    ...
    if(PT_H264 == mVEncChnAttr.VeAttr.Type)
    {
        switch(mVideoPDMode)
        {
            case VideoEncodeProductMode::NORMAL_MODE:
            {
                mVEncRcParam.product_mode = VENC_PRODUCT_NORMAL_MODE;
                break;
            }
            case VideoEncodeProductMode::IPC_MODE:
            {
        ...
        mVEncRcParam.sensor_type = (unsigned int)mSensorType;
        switch(mVideoRCMode)
        {
        ...
        if(VENC_RC_MODE_H264CBR == mVEncChnAttr.RcAttr.mRcMode)
        {
            ...
            mVEncRcParam.ParamH264Cbr.mMaxQp = mVEncRcAttr.mAttrH264Cbr.mMaxQp;
            mVEncRcParam.ParamH264Cbr.mMinQp = mVEncRcAttr.mAttrH264Cbr.mMinQp;
            mVEncRcParam.ParamH264Cbr.mMaxPqp = mVEncRcAttr.mAttrH264Cbr.mMaxPqp;
            mVEncRcParam.ParamH264Cbr.mMinPqp = mVEncRcAttr.mAttrH264Cbr.mMinPqp;
            mVEncRcParam.ParamH264Cbr.mQpInit = mVEncRcAttr.mAttrH264Cbr.mQpInit;
            mVEncRcParam.ParamH264Cbr.mbEnMbQpLimit = mVEncRcAttr.mAttrH264Cbr.mbEnMbQpLimit;
        }
        else if(VENC_RC_MODE_H264VBR == mVEncChnAttr.RcAttr.mRcMode)
        {
            ...
            mVEncRcParam.ParamH264Vbr.mMaxQp = mVEncRcAttr.mAttrH264Vbr.mMaxQp;
            mVEncRcParam.ParamH264Vbr.mMinQp = mVEncRcAttr.mAttrH264Vbr.mMinQp;
            mVEncRcParam.ParamH264Vbr.mMaxPqp = mVEncRcAttr.mAttrH264Vbr.mMaxPqp;
            mVEncRcParam.ParamH264Vbr.mMinPqp = mVEncRcAttr.mAttrH264Vbr.mMinPqp;
            mVEncRcParam.ParamH264Vbr.mQpInit = mVEncRcAttr.mAttrH264Vbr.mQpInit;
            mVEncRcParam.ParamH264Vbr.mbEnMbQpLimit = mVEncRcAttr.mAttrH264Vbr.mbEnMbQpLimit;
            mVEncRcParam.ParamH264Vbr.mMovingTh = mVEncRcAttr.mAttrH264Vbr.mMovingTh;
            mVEncRcParam.ParamH264Vbr.mQuality = mVEncRcAttr.mAttrH264Vbr.mQuality;
            mVEncRcParam.ParamH264Vbr.mIFrmBitsCoef = mVEncRcAttr.mAttrH264Vbr.mIFrmBitsCoef;
            mVEncRcParam.ParamH264Vbr.mPFrmBitsCoef = mVEncRcAttr.mAttrH264Vbr.mPFrmBitsCoef;
        }
    ...
    {        
        ...
        if(VENC_RC_MODE_H265CBR == mVEncChnAttr.RcAttr.mRcMode)
        {
            ...
            mVEncRcParam.ParamH265Cbr.mMaxQp = mVEncRcAttr.mAttrH265Cbr.mMaxQp;
            mVEncRcParam.ParamH265Cbr.mMinQp = mVEncRcAttr.mAttrH265Cbr.mMinQp;
            mVEncRcParam.ParamH265Cbr.mMaxPqp = mVEncRcAttr.mAttrH265Cbr.mMaxPqp;
            mVEncRcParam.ParamH265Cbr.mMinPqp = mVEncRcAttr.mAttrH265Cbr.mMinPqp;
            mVEncRcParam.ParamH265Cbr.mQpInit = mVEncRcAttr.mAttrH265Cbr.mQpInit;
            mVEncRcParam.ParamH265Cbr.mbEnMbQpLimit = mVEncRcAttr.mAttrH265Cbr.mbEnMbQpLimit;
        }
        else if(VENC_RC_MODE_H265VBR == mVEncChnAttr.RcAttr.mRcMode)
        {
            ...
            mVEncRcParam.ParamH265Vbr.mMaxQp = mVEncRcAttr.mAttrH265Vbr.mMaxQp;
            mVEncRcParam.ParamH265Vbr.mMinQp = mVEncRcAttr.mAttrH265Vbr.mMinQp;
            mVEncRcParam.ParamH265Vbr.mMaxPqp = mVEncRcAttr.mAttrH265Vbr.mMaxPqp;
            mVEncRcParam.ParamH265Vbr.mMinPqp = mVEncRcAttr.mAttrH265Vbr.mMinPqp;
            mVEncRcParam.ParamH265Vbr.mQpInit = mVEncRcAttr.mAttrH265Vbr.mQpInit;
            mVEncRcParam.ParamH265Vbr.mbEnMbQpLimit = mVEncRcAttr.mAttrH265Vbr.mbEnMbQpLimit;
            mVEncRcParam.ParamH265Vbr.mMovingTh = mVEncRcAttr.mAttrH265Vbr.mMovingTh;
            mVEncRcParam.ParamH265Vbr.mQuality = mVEncRcAttr.mAttrH265Vbr.mQuality;
            mVEncRcParam.ParamH265Vbr.mIFrmBitsCoef = mVEncRcAttr.mAttrH265Vbr.mIFrmBitsCoef;
            mVEncRcParam.ParamH265Vbr.mPFrmBitsCoef = mVEncRcAttr.mAttrH265Vbr.mPFrmBitsCoef;
        }
