...
{
    SampleVirvi2Fish2VoConfparser* pContext = (SampleVirvi2Fish2VoConfparser*) pThreadData;
    int ret;
    ...
    prctl(PR_SET_NAME, (unsigned long)"sample_virvi2fish2vo_DetectInput", 0, 0, 0);
    while(1)
    {
...
int main_sample_virvi2fish2vo(int argc, char *argv[])
{
...
FINSH_FUNCTION_EXPORT_ALIAS(main_sample_virvi2fish2vo, __cmd_sample_virvi2fish2vo, test mpp virvi2fish2vo);
