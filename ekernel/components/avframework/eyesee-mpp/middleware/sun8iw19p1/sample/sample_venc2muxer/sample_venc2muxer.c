 ...
 ******************************************************************************
  ...
  Created       : 2016/11/4
  Last Modified : 2021-06-03 19:02:16
  Description   :
  Function List :
  History       :
******************************************************************************/
...
static ERRORTYPE configMuxGrpAttr(SAMPLE_VENC2MUXER_S *pVenc2MuxerData)
{
    ...
    pVenc2MuxerData->mMuxGrpAttr.mVideoEncodeType = pVenc2MuxerData->mConfigPara.mVideoEncoderFmt;
    pVenc2MuxerData->mMuxGrpAttr.mWidth = pVenc2MuxerData->mConfigPara.dstWidth;
    pVenc2MuxerData->mMuxGrpAttr.mHeight = pVenc2MuxerData->mConfigPara.dstHeight;
    pVenc2MuxerData->mMuxGrpAttr.mVideoFrmRate = pVenc2MuxerData->mConfigPara.mVideoFrameRate*1000;
...
static int configVencChnAttr(SAMPLE_VENC2MUXER_S *pVenc2MuxerData)
{
    ...
    if (PT_H264 == pVenc2MuxerData->mVencChnAttr.VeAttr.Type)
    {
        ...
        default:
            ...
            pVenc2MuxerData->mVencRcParam.ParamH264Cbr.mMaxQp = 51;
            pVenc2MuxerData->mVencRcParam.ParamH264Cbr.mMinQp = 1;
            pVenc2MuxerData->mVencRcParam.ParamH264Cbr.mMaxPqp = 50;
            pVenc2MuxerData->mVencRcParam.ParamH264Cbr.mMinPqp = 10;
            pVenc2MuxerData->mVencRcParam.ParamH264Cbr.mQpInit = 30;
    ...
    else if (PT_H265 == pVenc2MuxerData->mVencChnAttr.VeAttr.Type)
    {
        ...
        default:
            ...
            pVenc2MuxerData->mVencRcParam.ParamH265Cbr.mMaxQp = 51;
            pVenc2MuxerData->mVencRcParam.ParamH265Cbr.mMinQp = 1;
            pVenc2MuxerData->mVencRcParam.ParamH265Cbr.mMaxPqp = 50;
            pVenc2MuxerData->mVencRcParam.ParamH265Cbr.mMinPqp = 10;
            pVenc2MuxerData->mVencRcParam.ParamH265Cbr.mQpInit = 30;
...
static ERRORTYPE prepare(SAMPLE_VENC2MUXER_S *pVenc2MuxerData)
{
    ...
    if (pVenc2MuxerData->mConfigPara.mVideoEncoderFmt == PT_H264)
    {
        ...
        AW_MPI_MUX_SetH264SpsPpsInfo(pVenc2MuxerData->mMuxGrp, &H264SpsPpsInfo);
    }
    else if(pVenc2MuxerData->mConfigPara.mVideoEncoderFmt == PT_H265)
    {
        ...
        AW_MPI_MUX_SetH265SpsPpsInfo(pVenc2MuxerData->mMuxGrp, &H265SpsPpsInfo);
    }
