...
int main_sample_adec(int argc, char *argv[])
{
    int result = 0;
    ...
    if(stContext.mConfigPara.mType == PT_G711U || stContext.mConfigPara.mType == PT_G711A || stContext.mConfigPara.mType == PT_G726)
    {
    ...
    if(stContext.mConfigPara.mType == PT_G711U || stContext.mConfigPara.mType == PT_G711A || stContext.mConfigPara.mType == PT_G726)
    {
        ...
        if(stContext.mConfigPara.mType == PT_G726)
        {
            stContext.mADecAttr.g726_src_enc_type = 1;
            stContext.mADecAttr.g726_src_bit_rate = 32000;
        }
    }
    else
    {
...
FINSH_FUNCTION_EXPORT_ALIAS(main_sample_adec, __cmd_sample_adec, test mpp adec);
