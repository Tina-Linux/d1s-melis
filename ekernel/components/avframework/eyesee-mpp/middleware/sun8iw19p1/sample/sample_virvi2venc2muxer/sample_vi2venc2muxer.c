 ...
 ******************************************************************************
  ...
  Created       : 2016/11/4
  Last Modified : 2021-05-24 17:28:22
  Description   :
  Function List :
  History       :
******************************************************************************/
...
static ERRORTYPE loadConfigPara(SAMPLE_VI2VENC2MUXER_S *pVi2Venc2MuxerData, const char *conf_path, int record_type)
{
    ...
    pVi2Venc2MuxerData->mConfigPara.mSensorType = VENC_ST_EN_WDR;
    ...
    pVi2Venc2MuxerData->mConfigPara.mSensorType = VENC_ST_DIS_WDR;
...
static ERRORTYPE configVencChnAttr(SAMPLE_VI2VENC2MUXER_S *pVi2Venc2MuxerData)
{
    ...
    if (PT_H264 == pVi2Venc2MuxerData->mVencChnAttr.VeAttr.Type)
    {
        ...
        case 1:
            ...
            pVi2Venc2MuxerData->mVencRcParam.ParamH264Vbr.mMinQp = 10;
            pVi2Venc2MuxerData->mVencRcParam.ParamH264Vbr.mMaxQp = 51;
            ...
            pVi2Venc2MuxerData->mVencRcParam.ParamH264Vbr.mbEnMbQpLimit = 0;
            pVi2Venc2MuxerData->mVencRcParam.ParamH264Vbr.mMovingTh = 20;
            pVi2Venc2MuxerData->mVencRcParam.ParamH264Vbr.mQuality = 5;
        ...
        default:
            ...
            pVi2Venc2MuxerData->mVencRcParam.ParamH264Cbr.mMaxQp = 51;
            pVi2Venc2MuxerData->mVencRcParam.ParamH264Cbr.mMinQp = 1;
            ...
            pVi2Venc2MuxerData->mVencRcParam.ParamH264Cbr.mbEnMbQpLimit = 0;
            break;
        }
    ...
    else if (PT_H265 == pVi2Venc2MuxerData->mVencChnAttr.VeAttr.Type)
    {
        ...
        case 1:
            ...
            pVi2Venc2MuxerData->mVencRcParam.ParamH265Vbr.mMinQp = 10;
            pVi2Venc2MuxerData->mVencRcParam.ParamH265Vbr.mMaxQp = 51;
            ...
            pVi2Venc2MuxerData->mVencRcParam.ParamH265Vbr.mbEnMbQpLimit = 0;
        ...
        default:
            ...
            pVi2Venc2MuxerData->mVencChnAttr.RcAttr.mAttrH265Cbr.mBitRate = pVi2Venc2MuxerData->mConfigPara.mVideoBitRate;
            pVi2Venc2MuxerData->mVencRcParam.ParamH265Cbr.mMaxQp = 51;
            pVi2Venc2MuxerData->mVencRcParam.ParamH265Cbr.mMinQp = 1;
            ...
            pVi2Venc2MuxerData->mVencRcParam.ParamH265Cbr.mbEnMbQpLimit = 0;
            break;
        }
        if (pVi2Venc2MuxerData->mConfigPara.mEnableFastEnc)
        {
