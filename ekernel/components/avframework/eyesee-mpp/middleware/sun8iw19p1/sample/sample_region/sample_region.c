...
//    }
    ...
    attr.format.colorspace = V4L2_COLORSPACE_REC709;
    ...
    if(bAddVencChannel)
    {
        ...
        if(PT_H264 == pContext->mVEncChnAttr.VeAttr.Type)
        {
            ...
            pContext->mVEncChnAttr.RcAttr.product_mode = VENC_PRODUCT_NORMAL_MODE;
        #if 0
            pContext->mVEncChnAttr.VeAttr.AttrH264e.bByFrame = TRUE;
            pContext->mVEncChnAttr.VeAttr.AttrH264e.Profile = 1;//2
            pContext->mVEncChnAttr.VeAttr.AttrH264e.mLevel = H264_LEVEL_32;//H264_LEVEL_51
            pContext->mVEncChnAttr.VeAttr.AttrH264e.PicWidth = wantedVideoSize.Width;
            pContext->mVEncChnAttr.VeAttr.AttrH264e.PicHeight = wantedVideoSize.Height;
            pContext->mVEncChnAttr.VeAttr.AttrH264e.mbPIntraEnable = TRUE;
            pContext->mVEncChnAttr.RcAttr.mRcMode = VENC_RC_MODE_H264VBR;
            pContext->mVEncChnAttr.RcAttr.mAttrH264Vbr.mMaxBitRate = wantedVideoBitRate;
            pContext->mVEncChnAttr.RcAttr.mAttrH264Vbr.mMaxQp = 51;
            pContext->mVEncChnAttr.RcAttr.mAttrH264Vbr.mMinQp = 30;
            pContext->mVEncChnAttr.RcAttr.mAttrH264Vbr.mMovingTh = 20;
            pContext->mVEncChnAttr.RcAttr.mAttrH264Vbr.mQuality = 8;
            pContext->mVEncChnAttr.RcAttr.product_mode = VENC_PRODUCT_IPC_MODE;
        #endif
        }
