...
extern unsigned int isp_cfg_log_para;

//#define ISP_DGB_FL
#include <utils/plat_log.h>
#define ISP_ERR(x, arg...) aloge("[ISP_ERR]%s, line: %d," x , __FUNCTION__, __LINE__, ##arg)
#define ISP_WARN(x, arg...) alogw("[ISP_WARN]" x , ##arg)
#define ISP_PRINT(x, arg...) alogd("[ISP]" x , ##arg) //printf
