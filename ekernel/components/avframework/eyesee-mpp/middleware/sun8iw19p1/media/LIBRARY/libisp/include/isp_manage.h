...
struct isp_hist_s {
	/* 0:AFTER_WDR UPDATE 1:AFTER_CNR UPDATE */
	HW_U8 sync_flag;
	HW_U32 last_wdr_lum;
	HW_U32 last_cnr_lum;
	HW_U32 last_wdr_cnt;
	HW_U32 last_cnr_cnt;
	HW_U32 hist_after_wdr[ISP_HIST_NUM];
	HW_U32 hist_after_cnr[ISP_HIST_NUM];
};
#endif
...
#endif
	HW_S32 awb_rgain_sum_for_ir;
	HW_S32 awb_bgain_sum_for_ir;
};
