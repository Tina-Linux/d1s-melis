...
void *VDecDev_MInit(__s32 *ret)
{
    ...
    pVDecOalCtx->video_conf.bDispErrorFrame = 1;
    ...
    pVDecOalCtx->video_conf.eOutputPixelFormat = PIXEL_FORMAT_NV21;
...
__s32 VDecDev_MIoctrl(void *pDecDev, __s32 cmd, __s32 aux, void *pbuffer)
{
    __s32    result;
    ...
    switch (cmd)
    {
        case VDRV_INTERNAL_CMD_QUERY_FRAME:
        {
            ...
            if (picture != NULL)
            {
                ...
                tmpDispFrm->top_y                         = (u32)picture->pData0;
                tmpDispFrm->top_u                         = (u32)picture->pData1;
                tmpDispFrm->top_v                         = (u32)picture->pData2;
        ...
        case VDRV_INTERNAL_CMD_SET_ROTATE:
        {
            ...
            pVideoDecCtx->vconfig.nRotateDegree = aux;

            if(aux != 0)
            {
                pVideoDecCtx->vconfig.bRotationEn = 1;
            }
        ...
        case VDRV_INTERNAL_CMD_ENABLE_MAF:
        {
            if (0 == aux)
            {
                pVideoDecCtx->vconfig.bSupportMaf = 0;
            }
            else
            {
