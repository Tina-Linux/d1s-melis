 ...
 *****************************************************************************
 * imx386_60fps_mipi
 * 1920x1080@60fps, wdr: 0
 * Hawkview ISP - imx386_60fps_mipi config module
...
#ifndef _IMX386_60FPS_MIPI_H_V200_
#define _IMX386_60FPS_MIPI_H_V200_

#include "../../include/isp_ini_parse.h"

struct isp_test_param imx386_60fps_mipi_isp_test_settings = {
	.isp_test_mode = 0,
	.isp_test_exptime = 0,
	.exp_line_start = 160,
	.exp_line_step = 32,
...
struct isp_3a_param imx386_60fps_mipi_isp_3a_settings = {
	.define_ae_table = 1,
	.ae_max_lv = 1650,
	.ae_table_preview_length = 6,
	.ae_table_preview = {
		 8000,  2000,   256,   256,   266,   266,
		 2000,  2000,   256,  2000,   266,   266,
		 2000,   100,  2000,  2000,   266,   266,
		  100,   100,  2000,  4000,   266,   266,
		  100,    60,  4000,  4000,   266,   266,
		   60,    60,  4000,  10000,   266,   266
	},
	...
	.awb_light_info = {
		  ...
		  120,   256,   102,   256,   256,   256,    60,  4000,    30,   100,
		  138,   256,   109,   250,   256,   256,    66,  4200,    99,    90,
...
struct isp_dynamic_param imx386_60fps_mipi_isp_iso_settings = {
	.triger = {
		.sharp_triger = 1,
		.contrast_triger = 1,
		.denoise_triger = 1,
	...
	.isp_dynamic_cfg[0] = {
		.sharp_cfg = {
			0, 6, 350, 350, 400, 512, 256, 0, 256, 0, 4, 4, 31, 20, 128, 280, 16, 128, 32, 31, 31, 2750, 2310, 1980, 1870, 128, 128, 48, 48
		},
		.contrast_cfg = {
			0, 6, 36, 24, 160, 512, 0, 256, 0, 256, 0
		},
		.denoise_cfg = {
			166, 0, 200, 0, 50, 100, 100, 64, 48, 32, 16, 20, 24, 28, 10, 67, 100, 133, 666, 666
		},
		.sensor_offset = {
			-256, -256, -256, -256
		},
		...
		.color_denoise = 1,
		.ae_cfg = {
			512, 512, 512, 512, 22, 22, 22, 22, 3, 64, 4, 35, 2, 20
		},
		.gtm_cfg = {
			512, 2, 10, 10, 215, 4, 1, 4, 0
		},
		.lca_cfg = {
	...
	.isp_dynamic_cfg[1] = {
		.sharp_cfg = {
			0, 8, 350, 350, 360, 440, 256, 0, 256, 0, 8, 8, 31, 15, 128, 320, 24, 128, 24, 31, 31, 2310, 1980, 1650, 1430, 128, 128, 48, 48
		},
		.contrast_cfg = {
			0, 8, 36, 24, 150, 256, 0, 256, 0, 256, 0
		},
		.denoise_cfg = {
			222, 0, 300, 0, 130, 180, 220, 64, 48, 32, 16, 20, 24, 28, 10, 67, 100, 133, 666, 666
		},
		.sensor_offset = {
			-256, -256, -256, -256
		},
		...
		.ae_cfg = {
			512, 512, 512, 512, 22, 22, 22, 22, 3, 62, 4, 35, 2, 20
		},
		.gtm_cfg = {
			512, 2, 10, 20, 215, 4, 1, 4, 0
		},
		.lca_cfg = {
			512, 768, 320, 96, 512, 9, 280, 32, 11, 15, 8
		},
	...
	.isp_dynamic_cfg[2] = {
		.sharp_cfg = {
			1, 24, 350, 256, 256, 384, 256, 0, 256, 0, 12, 12, 31, 15, 128, 320, 32, 128, 16, 31, 31, 2200, 1588, 1466, 1098, 128, 128, 48, 48
		},
		.contrast_cfg = {
			1, 16, 32, 32, 105, 256, 0, 256, 0, 256, 0
		},
		.denoise_cfg = {
			333, 0, 400, 0, 160, 200, 230, 64, 48, 32, 16, 20, 24, 28, 10, 67, 100, 133, 666, 666
		},
		.sensor_offset = {
			-254, -256, -256, -254
		},
		...
		.ae_cfg = {
			512, 512, 512, 512, 22, 22, 22, 22, 3, 60, 4, 35, 2, 20
		},
		.gtm_cfg = {
			512, 2, 10, 20, 215, 4, 1, 4, 0
		},
	...
	.isp_dynamic_cfg[3] = {
		.sharp_cfg = {
			3, 24, 350, 256, 256, 360, 256, 0, 256, 0, 2, 2, 20, 20, 32, 2048, 16, 128, 32, 31, 31, 1832, 1344, 1098, 976, 128, 128, 48, 48
		},
		.contrast_cfg = {
			3, 16, 32, 32, 105, 256, 0, 256, 0, 256, 0
		},
		.denoise_cfg = {
			666, 0, 633, 0, 200, 215, 240, 64, 48, 32, 16, 20, 24, 28, 10, 67, 100, 133, 666, 666
		},
		.sensor_offset = {
			-252, -256, -256, -252
		},
		...
		.ae_cfg = {
			512, 512, 512, 512, 22, 22, 22, 22, 3, 58, 4, 35, 2, 20
		},
		.gtm_cfg = {
			512, 2, 10, 20, 215, 4, 1, 4, 0
		},
	...
	.isp_dynamic_cfg[4] = {
		.sharp_cfg = {
			4, 24, 350, 256, 256, 320, 256, 0, 256, 0, 31, 31, 31, 4, 128, 320, 32, 128, 8, 31, 31, 1466, 155, 610, 488, 128, 128, 48, 48
		},
		.contrast_cfg = {
			4, 16, 36, 12, 105, 256, 64, 256, 0, 256, 0
		},
		.denoise_cfg = {
			1111, 0, 888, 0, 246, 246, 248, 64, 48, 32, 16, 20, 24, 28, 10, 67, 100, 133, 666, 666
		},
		.sensor_offset = {
			-250, -256, -256, -250
		},
		...
		.ae_cfg = {
			512, 512, 512, 512, 22, 22, 22, 22, 3, 56, 4, 30, 2, 25
		},
		.gtm_cfg = {
			512, 2, 10, 20, 215, 4, 1, 4, 0
		},
	...
	.isp_dynamic_cfg[5] = {
		.sharp_cfg = {
			10, 24, 350, 256, 256, 288, 256, 0, 256, 0, 31, 31, 31, 4, 128, 320, 32, 128, 6, 31, 31, 1588, 1098, 488, 366, 128, 128, 48, 48
		},
		.contrast_cfg = {
			4, 16, 34, 12, 105, 256, 80, 256, 0, 256, 0
		},
		.denoise_cfg = {
			1555, 0, 1422, 0, 255, 255, 255, 64, 48, 32, 16, 20, 24, 28, 10, 67, 100, 133, 666, 666
		},
		.sensor_offset = {
			-248, -256, -256, -248
		},
	...
	.isp_dynamic_cfg[6] = {
		.sharp_cfg = {
			12, 48, 350, 256, 256, 200, 256, 0, 256, 0, 31, 31, 31, 4, 128, 320, 32, 128, 4, 31, 31, 1344, 976, 704, 563, 128, 128, 128, 128
		},
		.contrast_cfg = {
		...
		.ae_cfg = {
			512, 512, 512, 512, 22, 22, 22, 22, 3, 52, 4, 30, 2, 25
		},
		.gtm_cfg = {
			512, 2, 10, 20, 215, 3, 1, 0, 0
		},
		.lca_cfg = {
			512, 768, 320, 96, 512, 9, 280, 32, 11, 15, 8
		},
	...
	.isp_dynamic_cfg[7] = {
		.sharp_cfg = {
			14, 60, 350, 200, 256, 200, 256, 0, 256, 0, 31, 31, 31, 4, 128, 320, 32, 128, 4, 31, 31, 1344, 976, 704, 563, 128, 128, 16, 16
		},
		.contrast_cfg = {
		...
		.ae_cfg = {
			512, 512, 512, 512, 22, 22, 22, 22, 3, 50, 4, 30, 2, 25
		},
		.gtm_cfg = {
			512, 2, 10, 20, 215, 4, 1, 0, 0
		},
		.lca_cfg = {
			512, 768, 320, 96, 512, 9, 280, 32, 11, 15, 8
		},
	...
	.isp_dynamic_cfg[8] = {
		.sharp_cfg = {
			16, 70, 555, 555, 256, 200, 256, 0, 256, 0, 31, 31, 31, 4, 128, 320, 32, 128, 4, 31, 31, 704, 563, 704, 563, 128, 128, 128, 128
		},
		.contrast_cfg = {
	...
	.isp_dynamic_cfg[9] = {
		.sharp_cfg = {
			18, 80, 166, 166, 255, 88, 256, 0, 256, 0, 31, 31, 31, 4, 128, 320, 32, 128, 4, 31, 31, 704, 563, 704, 563, 128, 128, 128, 128
		},
		.contrast_cfg = {
		...
		.ae_cfg = {
			512, 512, 512, 512, 22, 22, 22, 22, 3, 46, 4, 30, 2, 25
		},
		.gtm_cfg = {
			512, 2, 10, 10, 215, 4, 1, 0, 0
		},
		.lca_cfg = {
			512, 768, 320, 96, 512, 9, 280, 32, 11, 15, 8
		},
	...
	.isp_dynamic_cfg[10] = {
		.sharp_cfg = {
			20, 90, 122, 122, 200, 88, 256, 0, 256, 0, 31, 31, 31, 4, 128, 320, 32, 128, 4, 31, 31, 704, 563, 704, 563, 128, 128, 128, 128
		},
		.contrast_cfg = {
	...
	.isp_dynamic_cfg[11] = {
		.sharp_cfg = {
			22, 100, 88, 88, 188, 88, 256, 0, 256, 0, 31, 31, 31, 4, 128, 320, 32, 128, 4, 31, 31, 704, 563, 704, 563, 128, 128, 128, 128
		},
		.contrast_cfg = {
		...
		.ae_cfg = {
			512, 512, 512, 512, 22, 22, 22, 22, 3, 30, 4, 30, 2, 25
		},
		.gtm_cfg = {
			512, 2, 10, 10, 215, 3, 1, 0, 0
		},
	...
	.isp_dynamic_cfg[12] = {
		.sharp_cfg = {
			24, 110, 66, 66, 177, 88, 256, 0, 256, 0, 31, 31, 31, 4, 128, 320, 32, 128, 4, 31, 31, 704, 563, 704, 563, 128, 128, 128, 128
		},
		.contrast_cfg = {
	...
	.isp_dynamic_cfg[13] = {
		.sharp_cfg = {
			26, 120, 44, 44, 166, 88, 256, 0, 256, 0, 31, 31, 31, 4, 128, 320, 32, 128, 4, 31, 31, 704, 563, 704, 563, 128, 128, 128, 128
		},
		.contrast_cfg = {
...
struct isp_tunning_param imx386_60fps_mipi_isp_tuning_settings = {
	.flash_gain = 80,
...
struct isp_cfg_pt imx386_60fps_mipi_isp_cfg = {
	.isp_test_settings = &imx386_60fps_mipi_isp_test_settings,
	.isp_3a_settings = &imx386_60fps_mipi_isp_3a_settings,
	.isp_tunning_settings = &imx386_60fps_mipi_isp_tuning_settings,
	.isp_iso_settings = &imx386_60fps_mipi_isp_iso_settings
};


#endif /* end of _IMX386_60FPS_MIPI_H_V200_ */