 ...
 ******************************************************************************
  ...
  Created       : 2016/08/28
 *  Last Modified:  2021-04-23 10:36:48
...
ERRORTYPE AudioDec_InputDataInit(AUDIODEC_INPUT_DATA *pInputData, AUDIODECDATATYPE *pAudioDecData)
{
    ...
    alogd("create AudioDec Input threadId[0x%lx]", pInputData->thread_id);
...
static enum EAUDIOCODECFORMAT map_PAYLOAD_TYPE_E_to_EAUDIOCODECFORMAT(PAYLOAD_TYPE_E srcFormat)
{
    ...
    switch(srcFormat)
    {
        ...
        case PT_G711U:
            ...
            break;
        case PT_G726:
            dstFormat = AUDIO_CODEC_FORMAT_G726;
            break;
      default:
            dstFormat = AUDIO_CODEC_FORMAT_MPEG_AAC_LC;
...
ERRORTYPE AudioDecComponentInit(PARAM_IN COMP_HANDLETYPE hComponent)
{
    ...
    alogd("create AudioDec threadId[0x%lx]", pAudioDecData->thread_id);
...
PROCESS_MESSAGE:
        ...
        if (pAudioDecData->state == COMP_StateExecuting)
        {
            ...
            AudioStreamInfo *pAudioStreamInfo = &pAudioDecData->mAudioStreamInfo;
...
REREQUEST_OUT_BUFFER:
            ...
            if (ret == ERR_AUDIO_DEC_NONE)
            {
                ...
                {// get audio info only once
                    AudioStreamInfo *as_info = &pAudioDecData->mAudioStreamInfo;
