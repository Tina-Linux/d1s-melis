...
static int CedarvVideoEncInit(VIDEOENCDATATYPE *pVideoEncData)
{
    ...
    if(pVideoEncData->pCedarV)
    {
        ...
        else if(PT_H264 == pVideoEncData->mEncChnAttr.VeAttr.Type)
        {
            ...
            VideoEncSetParameter(pVideoEncData->pCedarV, VENC_IndexParamProductCase, &pVideoEncData->mRcParam.product_mode);
            VideoEncSetParameter(pVideoEncData->pCedarV, VENC_IndexParamSensorType, &pVideoEncData->mRcParam.sensor_type);
        }
        else if(PT_H265 == pVideoEncData->mEncChnAttr.VeAttr.Type)
        {
            VencH265Param h265Param;
        ...
        baseConfig.bIsVbvNoCache = 0;   //video encode config vbv buffer no cache!
        //baseConfig.memops = pVideoEncData->mMemOps;
        ...
        switch(pChnAttr->RcAttr.mRcMode)
        {
            ...
            case VENC_RC_MODE_H264FIXQP:
            {
                    ...
                    || pCurAttr->RcAttr.mAttrH264FixQp.mPQp != pChnAttr->RcAttr.mAttrH264FixQp.mPQp)
                {
                    ...
                    ret = VideoEncSetParameter(pVideoEncData->pCedarV, VENC_IndexParamH264FixQP, (void*)&stH264FixQp);
                    if (0 == ret)
                    {
            ...
            case VENC_RC_MODE_H264ABR:
            {
                    ...
                    || pCurAttr->RcAttr.mAttrH264Abr.mMinQp != pChnAttr->RcAttr.mAttrH264Abr.mMinQp)
                {
                    ...
                    ret = VideoEncSetParameter(pVideoEncData->pCedarV, VENC_IndexParamH264QPRange, (void*)&QpRange);
                    if (0 == ret)
                    {
            ...
            case VENC_RC_MODE_H265FIXQP:
            {
                    ...
                    || pCurAttr->RcAttr.mAttrH265FixQp.mPQp != pChnAttr->RcAttr.mAttrH265FixQp.mPQp)
                {
                    ...
                    ret = VideoEncSetParameter(pVideoEncData->pCedarV, VENC_IndexParamH264FixQP, (void*)&stH265FixQp);
                    if (0 == ret)
                    {
            ...
            case VENC_RC_MODE_MJPEGFIXQP:
            {
                if(pCurAttr->RcAttr.mAttrMjpegeFixQp.mQfactor != pChnAttr->RcAttr.mAttrMjpegeFixQp.mQfactor)
                {
                    ...
                    ret = VideoEncSetParameter(pVideoEncData->pCedarV, VENC_IndexParamJpegQuality, &jpegQuality);
                    if (0 == ret)
                    {
    ...
    if(pVideoEncData->pCedarV && pVideoEncData->mbCedarvVideoEncInitFlag)
    {
        ...
        if(pChnAttr->VeAttr.Type == pVideoEncData->mEncChnAttr.VeAttr.Type)
        {
            ...
            if(PT_H264 == pChnAttr->VeAttr.Type || PT_H265 == pChnAttr->VeAttr.Type)
            {
                ...
                {
                    ret = VideoEncSetParameter(pVideoEncData->pCedarV, VENC_IndexParamMaxKeyInterval, (void*)&pChnAttr->VeAttr.MaxKeyInterval);
                    if (0 == ret)
                    {
                ...
                {
                    ret = VideoEncSetParameter(pVideoEncData->pCedarV, VENC_IndexParamBitrate, (void*)&nBitRate1);
                    if (0 == ret)
                    {
                    ...
                    || (pCurAttr->VeAttr.AttrMjpeg.mPicHeight != pChnAttr->VeAttr.AttrMjpeg.mPicHeight))
                {
                    ...
                    if ((iPicEncDstWidth > 0) && (iPicEncDstHeight > 0))
                    {
                        if(pVideoEncData->mbCedarvVideoEncInitFlag)
                        {
                            ...
                            ret = VideoEncSetParameter(pVideoEncData->pCedarV, VENC_IndexParamUpdateBaseInfo, (void*)&pVideoEncData->mBaseConfig);
                            if (0 == ret)
                            {
        ...
        PARAM_OUT VENC_FRAME_RATE_S *pFrameRate)
{
	...
	{
		alogw("venc_set_src_frm_rate:%d-%d-%d",pVideoEncData->mFrameRateInfo.DstFrmRate,pVideoEncData->mFrameRateInfo.SrcFrmRate,pFrameRate->DstFrmRate);
...
ERRORTYPE VideoEncResetChannel(PARAM_IN COMP_HANDLETYPE hComponent, BOOL bForceReleaseOutFrameInNonTunnelMode)
{
    ...
    if(num > 0)
    {
        alogd("vencChn[%d] return [%d]frames!", pVideoEncData->mMppChnInfo.mChnId, num);
    }
    pthread_mutex_unlock(&pVideoEncData->mutex_fifo_ops_lock);
...
ERRORTYPE VideoEncSetH265Sao(
        PARAM_IN COMP_HANDLETYPE hComponent,
        PARAM_IN VencH265SaoS *h265SaoParam )
{
    ERRORTYPE eError;
    VIDEOENCDATATYPE *pVideoEncData = (VIDEOENCDATATYPE *) (((MM_COMPONENTTYPE*) hComponent)->pComponentPrivate);
    if(pVideoEncData->pCedarV)
    {
		memcpy(&pVideoEncData->h265SaoParam,h265SaoParam,sizeof(VencH265SaoS));
        if(0 == VideoEncSetParameter(pVideoEncData->pCedarV, VENC_IndexParamH265Sao, (void*)h265SaoParam))
        {
            eError = SUCCESS;
        }
        else
...
static ERRORTYPE VideoEncEnableBinImage(
        PARAM_IN COMP_HANDLETYPE hComponent, 
        PARAM_IN VencBinImageParam *pParam)
{
    ERRORTYPE eError = SUCCESS;
    int ret;
    VIDEOENCDATATYPE *pVideoEncData = (VIDEOENCDATATYPE *) (((MM_COMPONENTTYPE*) hComponent)->pComponentPrivate);
    if(pVideoEncData->pCedarV)
    {
        ret = VideoEncSetParameter(pVideoEncData->pCedarV, VENC_IndexParamEnableGetBinImage, (void*)pParam);
        if(0 == ret)
        {
            eError = SUCCESS;
        }
        ...
        {
            aloge("fatal error, enable GetBinImage fail[0x%x]!", ret);
            eError = ERR_VENC_BUSY;
        }
    }
    else
...
static ERRORTYPE VideoEncEnableMvInfo(
        PARAM_IN COMP_HANDLETYPE hComponent, 
        BOOL bEnable)
{
    ERRORTYPE eError = SUCCESS;
    ...
    if(pVideoEncData->pCedarV)
    {
        unsigned int uEnable = (unsigned int)bEnable;
        ret = VideoEncSetParameter(pVideoEncData->pCedarV, VENC_IndexParamEnableMvInfo, (void*)&uEnable);
        if(0 == ret)
        {
            eError = SUCCESS;
        }
        ...
        {
            aloge("fatal error! enable MvInfo fail[0x%x]!", ret);
            eError = ERR_VENC_BUSY;
        }
    }
    else
...
static ERRORTYPE VideoEncGetBinImageData(
        PARAM_IN COMP_HANDLETYPE hComponent, 
        PARAM_INOUT VENC_BinImageBuf *pImageBuf)
{
    ERRORTYPE eError = SUCCESS;
    int ret;
    VIDEOENCDATATYPE *pVideoEncData = (VIDEOENCDATATYPE *) (((MM_COMPONENTTYPE*) hComponent)->pComponentPrivate);
    if(pVideoEncData->pCedarV)
    {
        VencGetBinImageBufInfo stVencImageBuf;
        memset(&stVencImageBuf, 0, sizeof(VencGetBinImageBufInfo));
        stVencImageBuf.buf = pImageBuf->mpBuf;
        stVencImageBuf.max_size = pImageBuf->mBufSize;
        ret = VideoEncGetParameter(pVideoEncData->pCedarV, VENC_IndexParamGetBinImageData, (void*)&stVencImageBuf);
        if(ret >= 0)
        {
            pImageBuf->mDataLen = ret;
            eError = SUCCESS;
        }
        else
        {
            aloge("fatal error, GetBinImageData fail[0x%x]!", ret);
            pImageBuf->mDataLen = 0;
            eError = ERR_VENC_BUSY;
        }
    }
    else
...
static ERRORTYPE VideoEncGetMvInfoData(
        PARAM_IN COMP_HANDLETYPE hComponent, 
        PARAM_INOUT VENC_MvInfoBuf *pMvInfoBuf)
{
    ERRORTYPE eError = SUCCESS;
    int ret;
    VIDEOENCDATATYPE *pVideoEncData = (VIDEOENCDATATYPE *) (((MM_COMPONENTTYPE*) hComponent)->pComponentPrivate);
    if(pVideoEncData->pCedarV)
    {
        VencGetMvInfoBufInfo stVencMvInfoBuf;
        memset(&stVencMvInfoBuf, 0, sizeof(VencGetMvInfoBufInfo));
        stVencMvInfoBuf.buf = pMvInfoBuf->mpBuf;
        stVencMvInfoBuf.max_size = pMvInfoBuf->mBufSize;
        ret = VideoEncGetParameter(pVideoEncData->pCedarV, VENC_IndexParamGetMvInfoData, (void*)&stVencMvInfoBuf);
        if(ret >= 0)
        {
            pMvInfoBuf->mDataLen = ret;
            eError = SUCCESS;
        }
        else
        {
            aloge("fatal error, GetMvInfoData fail[0x%x]!", ret);
            pMvInfoBuf->mDataLen = 0;
            eError = ERR_VENC_BUSY;
        }
    }
    else
        ...
        PARAM_IN void* pComponentConfigStructure)
{
    ...
    switch(nIndex)
    {
        ...
        {
			VIDEOENCDATATYPE *pVideoEncData = (VIDEOENCDATATYPE *) (((MM_COMPONENTTYPE*) hComponent)->pComponentPrivate);
			memcpy((VencH265SaoS *)pComponentConfigStructure,&pVideoEncData->h265SaoParam,sizeof(VencH265SaoS));
            eError = ERR_VENC_NOT_SUPPORT;
            break;
        }
        ...
        case COMP_IndexVendorVencBinImageData:
        {
            eError = VideoEncGetBinImageData(hComponent, (VENC_BinImageBuf*)pComponentConfigStructure);
            break;
        }
        case COMP_IndexVendorVencMvInfoData:
        {
            eError = VideoEncGetMvInfoData(hComponent, (VENC_MvInfoBuf*)pComponentConfigStructure);
            break;
        }
        default:
        {
        ...
        PARAM_IN void* pComponentConfigStructure)
{
    ...
    switch (nIndex)
    {
        ...
        case COMP_IndexVendorVencH265Sao:
        {
			VideoEncSetH265Sao(hComponent,(VencH265SaoS *)pComponentConfigStructure);
            eError = ERR_VENC_NOT_SUPPORT;
            break;
        }
        case COMP_IndexVendorVencH265Timing:
        ...
        case COMP_IndexVendorVencEnableBinImage:
        {
            eError = VideoEncEnableBinImage(hComponent, (VencBinImageParam*)pComponentConfigStructure);
            break;
        }
        case COMP_IndexVendorVencEnableMvInfo:
        {
            eError = VideoEncEnableMvInfo(hComponent, *(BOOL*)pComponentConfigStructure);
            break;
        }
...
//            }
            alogd("chn[%d]: first video frame pts[%lld]us,tm1[%lld]us, vSize[%dx%d], frmId[%d,%d]",
                    pVideoEncData->mMppChnInfo.mChnId, pEncFrame->VFrame.mpts, tm1, pEncFrame->VFrame.mWidth, pEncFrame->VFrame.mHeight, pEncFrame->mId,pEncFrame->VFrame.mFramecnt);
        }
