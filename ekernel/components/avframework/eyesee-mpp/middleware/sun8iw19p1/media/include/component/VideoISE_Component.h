...
typedef struct {
    ...
    ISE_PROCOUT_PARA_GDC mIseGdcOut;
...
typedef struct VIDEOISEDATATYPE {
    ...
    ISE_HANDLE_GDC gdc_handle;

    //ISE handle default config
    ISE_CFG_PARA_MO fish_default_config;
    ISE_CFG_PARA_GDC fish_gdc_default_config;
    ...
    struct list_head mIdleChnAttrList;   // Add, ISEChnNode_t*
    struct list_head mValidChnAttrList;  // Run, ISEChnNode_t*
    ...
    BOOL mWaitSetGdcConfigFlag;
    pthread_mutex_t mWaitSetGdcConfigLock;
