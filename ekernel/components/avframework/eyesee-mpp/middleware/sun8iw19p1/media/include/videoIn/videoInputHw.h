...
VI_CHN_MAP_S *videoInputHw_CHN_MAP_S_Construct(void);
...
ERRORTYPE videoInputHw_Open_Media(void); /*Open Media+ISP+CSI Device*/
ERRORTYPE videoInputHw_Close_Media(void); /*Close Media+ISP+CSI Device*/
