...
#include "include/hal/aw-alsa-lib/pcm.h"
#include "include/hal/aw-alsa-lib/control.h"
...
//#define AUDIO_LINEOUTL_MUX      "Left LINEOUT Mux"            // perl board:1;ipc prototype board:0
    ...
    // for cap
#define AUDIO_MICIN_VOL		"MIC1 gain volume"            // set play volume
#define AUDIO_LINEININ_VOL      "LINEIN gain volume"            // set play volume
