...
#define alogv(fmt, arg...) GLOG_PRINT(PLAT_LOG_LEVEL_INFO, fmt, ##arg)
    ...
    do { \
        printf("%s %s " fmt "\n", StripFileName(__FILE__), XPOSTO(30) level, __FUNCTION__, __LINE__, ##arg); \
    } while(0)
...
#define aloge(fmt, arg...) PLATLOG(PLAT_LOG_LEVEL_ERROR, FMT_COLOR_FG(LIGHT, RED) "<%s:%d> " XPOSTO(60) FMT_DEFAULT fmt, ##arg)
#define alogw(fmt, arg...)
#define alogd(fmt, arg...)
#define alogv(fmt, arg...)
...
#define aloge(fmt, arg...) PLATLOG(PLAT_LOG_LEVEL_ERROR, FMT_COLOR_FG(LIGHT, RED) "<%s:%d> " XPOSTO(60) FMT_DEFAULT fmt, ##arg)
#define alogw(fmt, arg...) PLATLOG(PLAT_LOG_LEVEL_WARN, FMT_COLOR_FG(LIGHT, YELLOW) "<%s:%d> " XPOSTO(60) FMT_DEFAULT fmt, ##arg)
#define alogd(fmt, arg...)
#define alogv(fmt, arg...)
...
#define aloge(fmt, arg...) PLATLOG(PLAT_LOG_LEVEL_ERROR, FMT_COLOR_FG(LIGHT, RED) "<%s:%d> " XPOSTO(60) FMT_DEFAULT fmt, ##arg)
#define alogw(fmt, arg...) PLATLOG(PLAT_LOG_LEVEL_WARN, FMT_COLOR_FG(LIGHT, YELLOW) "<%s:%d> " XPOSTO(60) FMT_DEFAULT fmt, ##arg)
#define alogd(fmt, arg...) PLATLOG(PLAT_LOG_LEVEL_DEBUG, FMT_COLOR_FG(LIGHT, BLUE) "<%s:%d> " XPOSTO(60) FMT_DEFAULT fmt, ##arg)
#define alogv(fmt, arg...)
...
#define alogw(fmt, arg...) PLATLOG(PLAT_LOG_LEVEL_WARN, FMT_COLOR_FG(LIGHT, YELLOW) "<%s:%d> " XPOSTO(60) FMT_DEFAULT fmt, ##arg)
#define alogd(fmt, arg...) PLATLOG(PLAT_LOG_LEVEL_DEBUG, FMT_COLOR_FG(LIGHT, BLUE) "<%s:%d> " XPOSTO(60) FMT_DEFAULT fmt, ##arg)
#define alogv(fmt, arg...) PLATLOG(PLAT_LOG_LEVEL_VERBOSE, FMT_COLOR_FG(LIGHT, WRITE) "<%s:%d> " XPOSTO(60) FMT_DEFAULT fmt, ##arg)
