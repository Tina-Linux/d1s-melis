...
static inline void *dev_get_drvdata(const struct rt_device *dev)
{
        return dev->user_data;
}

static inline void dev_set_drvdata(struct rt_device *dev, void *data)
{
        dev->user_data = data;
}
 ...
 */
int  v4l2_device_register(struct rt_device *dev,
