...
s32 tvd_set_sharpness(u32 sel, u32 sharpness)
{
	...
	{
		tvd_device[sel]->tvd_enhance1.bits.sharp_en = 1;
		tvd_device[sel]->tvd_enhance1.bits.sharp_coef1 = 0x0;
		tvd_device[sel]->tvd_enhance1.bits.sharp_coef2 = 0x0;
	}
	else if(sharpness == 1)
	{
		tvd_device[sel]->tvd_enhance1.bits.sharp_en = 1;
		tvd_device[sel]->tvd_enhance1.bits.sharp_coef1 = 0x01;
		tvd_device[sel]->tvd_enhance1.bits.sharp_coef2 = 0x01;
	}
	else if(sharpness == 2)
	{
		tvd_device[sel]->tvd_enhance1.bits.sharp_en = 1;
		tvd_device[sel]->tvd_enhance1.bits.sharp_coef1 = 0x02;
		tvd_device[sel]->tvd_enhance1.bits.sharp_coef2 = 0x01;
	}
	else if(sharpness == 3)
	{
		tvd_device[sel]->tvd_enhance1.bits.sharp_en = 1;
		tvd_device[sel]->tvd_enhance1.bits.sharp_coef1 = 0x03;
		tvd_device[sel]->tvd_enhance1.bits.sharp_coef2 = 0x01;
	}
	else if(sharpness == 4)
	{
		tvd_device[sel]->tvd_enhance1.bits.sharp_en = 1;
		tvd_device[sel]->tvd_enhance1.bits.sharp_coef1 = 0x04;
		tvd_device[sel]->tvd_enhance1.bits.sharp_coef2 = 0x01;
	}
	else if(sharpness == 5)
	{
		tvd_device[sel]->tvd_enhance1.bits.sharp_en = 1;
		tvd_device[sel]->tvd_enhance1.bits.sharp_coef1 = 0x05;
		tvd_device[sel]->tvd_enhance1.bits.sharp_coef2 = 0x01;
	}
	else if(sharpness == 6)
	{
		tvd_device[sel]->tvd_enhance1.bits.sharp_en = 1;
		tvd_device[sel]->tvd_enhance1.bits.sharp_coef1 = 0x06;
		tvd_device[sel]->tvd_enhance1.bits.sharp_coef2 = 0x01;
	}
	else
	{
		tvd_device[sel]->tvd_enhance1.bits.sharp_en = 1;
		tvd_device[sel]->tvd_enhance1.bits.sharp_coef1 = 0x07;
		tvd_device[sel]->tvd_enhance1.bits.sharp_coef2 = 0x01;
	}
...
{
	tvd_device[sel]->tvd_debug2.bits.hue = hue;
	return 0;
}
...
{
	return tvd_device[sel]->tvd_enhance1.bits.sharp_coef1 / tvd_device[sel]->tvd_enhance1.bits.sharp_coef1;
}

u32 tvd_get_hue(u32 sel)
{
	return tvd_device[sel]->tvd_debug2.bits.hue;
}
			  ...
			  u32 data_length)
{
	...
	__tvd_dev_t *tvd_dev_bak = hal_malloc(sizeof(__tvd_dev_t));
	__tvd_top_dev_t *tvd_top_bak = hal_malloc(sizeof(__tvd_top_dev_t));
	if (!tvd_dev_bak || !tvd_top_bak) {
		pr_warn("%s(), malloc memroy fail\n", __func__);
		hal_free(tvd_top_bak);
		hal_free(tvd_dev_bak);
		return -1;
	}
	memset(tvd_dev_bak, 0, sizeof(__tvd_dev_t));
	memset(tvd_top_bak, 0, sizeof(__tvd_top_dev_t));
...
{
	tvd_device[sel]->tvd_debug7.bits.agc_half_en = 0; //disable agc_half
