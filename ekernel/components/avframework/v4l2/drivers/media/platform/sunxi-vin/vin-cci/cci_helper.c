/*
 * ekernel/components/avframework/v4l2/platform/sunxi-vin/vin-cci/cci_helper.c
 *
...
#include "../utility/vin_config_sun8iw19p1.h"
#elif CONFIG_SOC_SUN20IW1P1
#include "../utility/vin_config_sun20iw1p1.h"
#endif
...
{
	int ret;
	int slave_addr = sensors_default[0].inst->cam_addr >> 1;
	...
	hal_twi_control(cci_drv->cci_id, I2C_SLAVE, &slave_addr);

	vin_log(VIN_LOG_POWER, "%s:id = %d, slave = 0x%x\n", __func__,
					cci_drv->cci_id, slave_addr);
