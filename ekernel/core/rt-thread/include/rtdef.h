...
typedef rt_ubase_t                      rt_tick_t;      /**< Type for tick count */
...
#define RT_UINT64_MAX                   0xffffffffffffffff      /**< Maxium number of UINT32 */
#ifndef __LP64__
#define RT_TICK_MAX                     RT_UINT32_MAX   /**< Maxium number of tick */
#else
#define RT_TICK_MAX                     RT_UINT64_MAX   /**< Maxium number of tick */
#endif
...
struct rt_thread
{
    ...
    void        *lwp;
#endif
    void *user_data[4];                                 /**< private user data beyond this thread */
#ifdef CONFIG_RISCV
    fpu_context_t  fdext_ctx;                           /**< backup fpu register status */
#endif
    rt_tick_t   cputime;                                /**< log the actual running time of the thread */
    rt_tick_t   montime;                                /**< log the monitor start time, should be equal cputime before each period */
    rt_uint32_t sched_i;
    rt_uint32_t sched_o;
    rt_tick_t   born;
    rt_ubase_t preempt_count;
};
