...
void rt_thread_idle_init(void)
{
    ...
    rt_thread_init(&idle,
                   ...
                   32);
#else
    extern uint8_t __init_process_stack_start__[];
    extern uint8_t __init_process_stack_end__[];
    rt_thread_init(&idle,
                   "tidle",
                   rt_thread_idle_entry,
                   RT_NULL,
                   __init_process_stack_start__,
                   (rt_uint32_t)__init_process_stack_end__ - (rt_uint32_t)__init_process_stack_start__,
                   RT_THREAD_PRIORITY_MAX - 1,
                   32);
