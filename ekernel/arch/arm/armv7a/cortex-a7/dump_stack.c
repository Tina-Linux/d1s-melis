...
* =====================================================================================
*
*       Filename:  dump_stack.c
*
*    Description:  dump the call stack.
*
*        Version:  Melis3.0
*         Create:  2018-02-07 19:29
*       Revision:  none
*       Compiler:  gcc version 6.3.0 (crosstool-NG crosstool-ng-1.23.0)
*
*         Author:  zhijinzeng@allwinnertech.com
*   Organization:  BU1-PSW
 *  Last Modified:  2019-05-24 17:45:26
*
* =====================================================================================
*/
 ...
 *    ¦   ¦   rt_kprintf("backtrace: reached task root!!!\r\n");
 *    ¦   ¦   break;
 *    ¦   }
 *
 *    ¦   rt_kprintf("backtrace: %p\r\n", pc);
 *
...
{
    __log("Function entered at [<0x%08x>] from [<0x%08x>]", where, from);
}
