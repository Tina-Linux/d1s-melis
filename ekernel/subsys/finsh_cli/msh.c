...
static int msh_enter(int argc, const char **argv)
{
    (void)argc;
    (void)argv;
...
#endif
static int msh_hello(int argc, const char **argv)
{
    (void)argc;
    (void)argv;
...
FINSH_FUNCTION_EXPORT_ALIAS(msh_hello, __cmd_hello, say hello shell);
