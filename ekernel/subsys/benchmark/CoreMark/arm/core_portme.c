...
#define GETMYTIME(_t)  do {} while(0)
...
static __u32 start_time_val, stop_time_val;
...
{
    secs_ret retval = ((secs_ret)ticks) / (secs_ret)100;
    return retval;
}
#else
