...
status_t EyeseeThumbRetriever::prepare()
{
    ...
    if(mJpegWidth > 0 && mJpegHeight > 0 && mVdecChn >= 0)
    {
        ...
        mVecChnAttr.VeAttr.AttrJpeg.BufSize = ((((mJpegWidth * mJpegHeight * 3) >> 2) + 1023) >> 10) << 10;
        ...
        mVecChnAttr.VeAttr.SrcPicWidth = DemuxMediaInfo.mVideoStreamInfo[DemuxMediaInfo.mVideoIndex].mWidth;
        mVecChnAttr.VeAttr.SrcPicHeight = DemuxMediaInfo.mVideoStreamInfo[DemuxMediaInfo.mVideoIndex].mHeight;
