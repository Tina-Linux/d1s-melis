 ...
 ******************************************************************************
  ...
  Created       : 2020/5/15
 *  Last Modified:  2020-05-26 09:58:24
  Description   :
  Function List :
  History       :
******************************************************************************/
...
static int loadSampleMultiVi2venc2muxerConfig(SampleMultiVi2venc2muxerContext *pThiz, const char *conf_path)
{
    ...
    strcpy(pThiz->mConfigPara.mVideoAFile, "/mnt/E/1080p.mp4");
    ...
    strcpy(pThiz->mConfigPara.mVideoEFileJpeg, "/mnt/E/1080p.jpeg");
...
static int startVipp(VippConfig *pVipp, bool bForceRef)
{
    int result = 0;
...
static int createViChn(Vi2venc2muxerContext *pRecCtx)
{
    ...
    while(1)
    {
        ret = AW_MPI_VI_CreateVirChn(pRecCtx->mpConnectVipp->mViDev, pRecCtx->mViChn, NULL);
        if(SUCCESS == ret)
        {
            break;
        }
        ...
        case PT_H264:
        {
            switch (pRecCtx->mVideoRcMode)
            {
                case 1:
                {
                    ...
                    pRecCtx->mVencChnAttr.RcAttr.mAttrH264Vbr.mMaxQp = 51;
                    pRecCtx->mVencChnAttr.RcAttr.mAttrH264Vbr.mMinQp = 10;
                    pRecCtx->mVencChnAttr.RcAttr.mAttrH264Vbr.mMovingTh = 20;
                    pRecCtx->mVencChnAttr.RcAttr.mAttrH264Vbr.mQuality = 5;
                    break;
                }
                case 2:
                {
                ...
                default:
                {
                    ...
                    pRecCtx->mVencChnAttr.RcAttr.mAttrH264Cbr.mMaxQp = 51;
                    pRecCtx->mVencChnAttr.RcAttr.mAttrH264Cbr.mMinQp = 1;
                    break;
                }
            }
            break;
        ...
        case PT_H265:
        {
            switch (pRecCtx->mVideoRcMode)
            {
                case 1:
                {
                    ...
                    pRecCtx->mVencChnAttr.RcAttr.mAttrH265Vbr.mMaxQp = 51;
                    pRecCtx->mVencChnAttr.RcAttr.mAttrH265Vbr.mMinQp = 10;
                    pRecCtx->mVencChnAttr.RcAttr.mAttrH265Vbr.mMovingTh = 20;
                    pRecCtx->mVencChnAttr.RcAttr.mAttrH265Vbr.mQuality = 5;
                    break;
                }
                case 2:
                {
                ...
                default:
                {
                    ...
                    pRecCtx->mVencChnAttr.RcAttr.mAttrH265Cbr.mMaxQp = 51;
                    pRecCtx->mVencChnAttr.RcAttr.mAttrH265Cbr.mMinQp = 1;
                    break;
                }
            }
            break;
...
//    }
    ...
    for(i=0; i<MAX_VIPP_DEV_NUM; i++)
    {
        if(pContext->mVippConfigs[i].mbValid)
        {
            result = startVipp(&pContext->mVippConfigs[i], bForceRef);
            if (result != 0)
            {
