...
#define DEFAULT_DST_FILE_PATH       "/mnt/E/test.aac"
...
int main_sample_ai2aenc2muxer(int argc, char** argv)
{
    ERRORTYPE ret = 0;
...
FINSH_FUNCTION_EXPORT_ALIAS(main_sample_ai2aenc2muxer, __cmd_sample_ai2aenc2muxer, test mpp ai2aenc2muxer);
