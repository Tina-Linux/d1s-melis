...
#define cdxfopen64(uri) open(uri, O_RDONLY) //O_LARGEFILE

#define cdxfseek64(fd, offset, whence) lseek64(fd, offset, whence)  //lseek64

#define cdxftell64(fd) lseek64(fd, 0, SEEK_CUR) //lseek64
...
static char *FdToFilepath(const int fd)
{
    ...
    CDX_LOGW("Be careful. not support readlink()!");
