...
static MUX_CHN_GROUP_S* MUX_CHN_GROUP_S_Construct(void)
{
...
{
    return AW_MPI_MUX_SetH264SpsPpsInfo(muxGrp, pH265SpsPpsInfo);
}
...
ERRORTYPE AW_MPI_MUX_SetMuxCacheDuration(MUX_GRP muxGrp, int nCacheMs)
{
    ...
    return COMP_SetConfig(pGrp->mComp, COMP_IndexVendorsetMuxCacheDuration, &mCacheMs);
}
