...
ERRORTYPE AW_MPI_DEMUX_CreateChn(PARAM_IN DEMUX_CHN dmxChn, PARAM_IN const DEMUX_CHN_ATTR_S *pAttr)
{
...
ERRORTYPE AW_MPI_DEMUX_GetChnAttr(PARAM_IN DEMUX_CHN dmxChn, PARAM_OUT DEMUX_CHN_ATTR_S *pAttr)
{
    if(!(dmxChn>=0 && dmxChn <DEMUX_MAX_CHN_NUM))
    {
        aloge("fatal error! invalid DemuxChn[%d]!", dmxChn);
...
static ERRORTYPE convert_CdxMediaInfoT_to_DEMUX_MEDIA_INFO_S(DEMUX_MEDIA_INFO_S *pDemuxMediaInfo, CdxMediaInfoT *pCdxMediaInfo)
{
    ...
    if(pProgram->audioNum > 0)
    {
        ...
        {
            pDemuxMediaInfo->mAudioStreamInfo[i].mCodecType = map_EAUDIOCODECFORMAT_to_PAYLOAD_TYPE_E(pProgram->audio[i].eCodecFormat);
...
ERRORTYPE AW_MPI_DEMUX_GetMediaInfo(PARAM_IN DEMUX_CHN dmxChn, PARAM_OUT DEMUX_MEDIA_INFO_S *pDemuxMediaInfo)
{
    if(!(dmxChn>=0 && dmxChn <DEMUX_MAX_CHN_NUM))
    {
        aloge("fatal error! invalid DemuxChn[%d]!", dmxChn);
...
//ERRORTYPE AW_MPI_DEMUX_DisableTrack(PARAM_IN DEMUX_CHN dmxChn, PARAM_IN int nDisableTrack)
//{
//    if(!(dmxChn>=0 && dmxChn <DEMUX_MAX_CHN_NUM))
//    {
//        aloge("fatal error! invalid DemuxChn[%d]!", dmxChn);
...
//ERRORTYPE AW_MPI_DEMUX_DisableMediaType(PARAM_IN DEMUX_CHN dmxChn, PARAM_IN int nDisableMediaType)
//{
//    if(!(dmxChn>=0 && dmxChn <DEMUX_MAX_CHN_NUM))
//    {
//        aloge("fatal error! invalid DemuxChn[%d]!", dmxChn);
