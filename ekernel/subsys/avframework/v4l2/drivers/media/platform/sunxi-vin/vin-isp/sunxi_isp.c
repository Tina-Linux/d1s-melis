/*
 * ekernel/subsys/avframework/v4l2/platform/sunxi-vin/vin-isp/sunxi_isp.c
 *
...
#if defined CONFIG_ARCH_SUN8IW16P1 || defined CONFIG_SOC_SUN8IW19P1 || defined CONFIG_ARCH_SUN50IW10P1
...
static int isp_probe(int id)
{
	...
	if (!isp->base) {
		...
		ret = request_irq(isp->irq, isp_isr, 0, "sunxi_isp", isp);
		if (ret) {
