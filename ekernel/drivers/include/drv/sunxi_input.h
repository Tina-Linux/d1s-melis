...
static inline int __test_bit(unsigned int code, unsigned int key)
{
    return code == key;
}

static inline void __change_bit(unsigned int code, unsigned int *key)
{
    *key = code;
}

static inline void __clear_bit(unsigned int *key)
{
    *key = 0;
}
/******************************input event define***************************************/
