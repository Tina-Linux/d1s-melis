...
# os
__CONFIG_OS_FREERTOS ?= n
__CONFIG_OS_RTTHREAD ?= n
__CONFIG_OS_YUNOS    ?= n
...
__CONFIG_SECTION_ATTRIBUTE_SRAM ?= n
...
ifeq ($(__CONFIG_OS_RTTHREAD), y)
  CONFIG_SYMBOLS += -D__CONFIG_OS_RTTHREAD
endif

ifeq ($(__CONFIG_OS_YUNOS), y)
  CONFIG_SYMBOLS += -D__CONFIG_OS_YUNOS
endif
