...
static int cmd_date_test(int argc, char **argv)
{
	int opt;
	char   *string = "hgs:";
...
/*
 * changed the cmd date to date_test .
 * date is the default command.If you define the date command privately,command conflicts may occur
 */
FINSH_FUNCTION_EXPORT_CMD(cmd_date_test, date_test, date in rtc tools)
