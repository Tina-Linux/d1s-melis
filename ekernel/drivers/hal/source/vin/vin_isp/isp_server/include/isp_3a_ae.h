/*
 * linux-4.9/drivers/media/platform/sunxi-vin/vin-isp/isp_server/include/isp_3a_ae.h
 *
...
#define ISP_AE_START_FRAME_NUM	2
...
typedef struct isp_ae_param {
	...
	bool fast_convergence_wdr_en;
	bool adc_fast_convergence;
} ae_param_t;
...
typedef struct isp_ae_result {
	...
	HW_U32 fast_convergence_exp;
	HW_U32 fast_convergence_gain;
	HW_U32 fast_convergence_ev_idx;
	HW_U8 ir_status_output;
	HW_S16 day_to_ir_night_th;
	HW_S16 ir_night_to_day_th;
	HW_S16 ir_awb_gain_th;
} ae_result_t;
