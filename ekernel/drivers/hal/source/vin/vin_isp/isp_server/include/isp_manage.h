/*
 * linux-4.9/drivers/media/platform/sunxi-vin/vin-isp/isp_server/include/isp_manage.h
 *
...
//#include "../isp_special_video/isp_ldci_video.h"

#define ISP_FAST_CONVERGENCE_FPS 60
...
enum isp_wdr_mode_t {
	ISP_NORMAL_MODE_T = 0,
	ISP_2FDOL_WDR_MODE_T,/*L+M*/
	ISP_2FCMD_WDR_MODE_T,/*LM--L+M*/
	ISP_SEHDR_MODE_T,
	ISP_3FDOL_WDR_MODE_T,/*L+M+S*/
	ISP_3FDOL_LM_WDR_MODE_T,/*LM+M+S*/
	ISP_3FDOL_MS_WDR_MODE_T,/*L+M+MS*/
	ISP_3FCMD_WDR_MODE_T,/*LMS--L+M+S*/
	ISP_3FCMD_LM_WDR_MODE_T,/*LMS--LM+M+S*/
	ISP_3FCMD_MS_WDR_MODE_T,/*LMS--L+M+MS*/
	ISP_2FCMD1FDOL_WDR_MODE_T,/*LM+S--LM+M+S*/
	ISP_1FDOL2FCMD_WDR_MODE_T,/*L+MS--L+M+MS*/
};
...
struct isp_lib_context {
	HW_S32 isp_id;
	struct file *stat_log_fd;
	struct file *isp_log_fd;
