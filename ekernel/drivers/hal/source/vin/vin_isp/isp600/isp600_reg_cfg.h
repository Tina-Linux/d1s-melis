...
#if 1
#include "../isp_server/include/isp_comm.h"
...
void bsp_isp_adbset_save_load_addr(unsigned long id, unsigned long addr);
...
void bsp_isp_set_save_load_addr(unsigned long id, unsigned long addr);
...
void bsp_isp_set_d3d_bayer_addr(unsigned long id, unsigned long addr);
void bsp_isp_set_d3d_k0_addr(unsigned long id, unsigned long addr);
void bsp_isp_set_d3d_k1_addr(unsigned long id, unsigned long addr);
void bsp_isp_set_d3d_status_addr(unsigned long id, unsigned long addr);
