...
static int cp1252_mbtowc(__u16 *pwc, const unsigned char *s, int n)
{
    unsigned char c;
...
static int cp1252_wctomb(unsigned char *r, __u16 wc, int n)
{
    unsigned char c = 0;
...
__s32 CP1252_uni2char(const __u16 uni, __u8 *out, __u32 boundlen)
{
    __s32 n;
    n = cp1252_wctomb(out, uni, boundlen);
...
__s32 CP1252_char2uni(const __u8 *rawstring, __u32 boundlen, __u16 *uni)
{
    __s32 n;
    n = cp1252_mbtowc(uni, rawstring, boundlen);
...
__u32 CP1252_get_charset2upper_table(void *buf, __u32 size)
{
    __u32  len;
...
__u32 CP1252_get_charset2lower_table(void *buf, __u32 size)
{
    __u32  len;
