...
* Moudle  : lemon
* File    : LCDL0Delta.c
* Purpose : Link between GUI and LCD_L0... if delta display needs to be supported
*
* By      : Miracle
* Version : v1.0
...
**********************************************************************
*/
static       U8             _aPixelData_0[Screen_Context.LCDXSize];
static       U8             _aPixelData_1[Screen_Context.LCDXSize];
